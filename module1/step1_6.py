...
try:
    ...
    input1.send_keys(''.join(random.choice(string.ascii_lowercase) for i in range(8)))
    time.sleep(1)
    input2 = browser.find_element(By.CSS_SELECTOR, ".first_block .form-group.second_class  input")
    input2.send_keys(''.join(random.choice(string.ascii_lowercase) for i in range(8)))
    time.sleep(1)
    input3 = browser.find_element(By.CSS_SELECTOR, ".form-group.third_class  input")
    input3.send_keys(''.join(random.choice(string.ascii_lowercase) for i in range(8)))
    time.sleep(1)
